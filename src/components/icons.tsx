...
export const CrownIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M18.97 18.251a2.25 2.25 0 01-2.22 2.499H7.25a2.25 2.25 0 01-2.22-2.5A20.183 20.183 0 018.816 6.01L6 3.193V3a.75.75 0 011.5 0v.193l2.816 2.817a20.184 20.184 0 012.368 0L15.5 3.193V3a.75.75 0 011.5 0v.193l-2.816 2.817a20.183 20.183 0 013.786 12.24z" clipRule="evenodd" />
  </svg>
);
...
export const HintIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
...
export const DoublePointsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className} stroke="currentColor" strokeWidth="1">
